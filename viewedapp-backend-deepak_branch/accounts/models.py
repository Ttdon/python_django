...
class ViewingAndViewers(models.Model):
    ...
    def __str__(self):
        return str(self.id)+'-'+self.viewed_by.first_name + '-' + str(self.viewed_to.first_name)
...
#     profile_viewed_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='profile_viewed_by')
#     profile_viewed_to = models.ForeignKey(User, on_delete=models.CASCADE, related_name='profile_viewed_to')
#     created = models.DateTimeField(auto_now_add=True)
#
#     def __int__(self):
#         return str(self.profile_viewed_by.id) + '-' + str(self.profile_viewed_to.id)

class ProfileViewsCountRecord(models.Model):
    profile_viewed_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='profile_viewed_count_by')
    profile_viewed_to = models.ForeignKey(User, on_delete=models.CASCADE, related_name='profile_viewed_count_to')
    created = models.DateTimeField(auto_now_add=True)
