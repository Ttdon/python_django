...
class ViewersListSerializer(ModelSerializer):
    ...
    def get_id(self, instance):
        return instance.viewed_by.id

    def get_first_name(self , instance):
        return instance.viewed_by.first_name

    def get_last_name(self, instance):
        return instance.viewed_by.last_name

    def get_profile_image(self, instance):
        if instance.viewed_by.profile_image:
            return instance.viewed_by.profile_image.url
        return None
