...
class AccountsProfileviewscountrecord(models.Model):
    ...
    profile_viewed_by = models.ForeignKey('AccountsUser', models.DO_NOTHING)
    profile_viewed_to = models.ForeignKey('AccountsUser', models.DO_NOTHING)
...
class AccountsViewingandviewers(models.Model):
    ...
    viewed_by = models.ForeignKey(AccountsUser, models.DO_NOTHING)
    viewed_to = models.ForeignKey(AccountsUser, models.DO_NOTHING)
    created = models.DateTimeField()
