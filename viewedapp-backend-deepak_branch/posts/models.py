...
class CompetitionPost(models.Model):
    ...
    viewed_by = models.PositiveSmallIntegerField(default=0)
...
class CompetitionViewedByUsers(models.Model):
    post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='viewed_comp_post')
    viewed_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='viewed_user')
    created = models.DateTimeField(auto_now_add=True)
